...
<img src={Logo} alt="" style={{height:"10vh"}} />
      ...
      <motion.div   
          initial={{  x:0, y :-100}}
          animate={{x:0,y :0 }}
          transition={{ delay: 0.5 , duration : 3 , type: "spring", stiffness: "160" }} 
          className="iconUser">
      ...
      <motion.div   
          ...
          transition={{ delay: 0.5 , duration : 3 , type: "spring", stiffness: "160" }} 
          className="">
             <Link to="/" ><img src={Home} style={{width: "70px",height: "70px"}} alt=""/></Link>
             <p onClick={()=> {goingBack()}}> <img src={GoBack} style={{width: "70px",height: "70px"}} alt=""/></p>
